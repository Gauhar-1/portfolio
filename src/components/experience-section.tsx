...
const ExperienceSection = () => {
    ...
    // FIX 1: Safe Component Lifecycle Fetching
    useEffect(() => {
        let isMounted = true; 
        ...
        const fetchExperiences = async () => {
            try {
                ...
                // Removed the dangerous setTimeout ScrollTrigger.refresh()
            }
        };
        fetchExperiences();
    ...
    // FIX 2: Stable DOM Rendering for GSAP Pinning
    return (
        <section ref={sectionRef} id="experience" className="bg-[#0a0a0a] text-slate-200 overflow-hidden font-sans h-[100dvh] w-full relative">
            ...
            {isLoading ? (
                <div className="absolute inset-0 z-50 bg-[#0a0a0a] flex flex-col items-center justify-center font-mono text-white/50 text-sm tracking-widest px-4 text-center">
